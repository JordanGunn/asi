...
- small illustrative clarifications that reinforce existing rules without expanding scope
...
3. Run `scripts/lint_markdown.sh` and `scripts/lint_shell_portability.sh` (where applicable).
...
- [Reference Skills](./skills/) — Reference skills and wrappers
