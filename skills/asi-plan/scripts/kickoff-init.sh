...
# asi-plan kickoff-phase initialization script
...
cat << EOF
{
  ...
  "next_step": 1,
  "next_action": "Fill Purpose section in KICKOFF.md, then run: scripts/kickoff-checkpoint.sh --step 1"
}
EOF
