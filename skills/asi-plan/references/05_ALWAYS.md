...
- Always assess risks from KICKOFF.md judgment remainder
- Always set artifact status to `draft`
- Always include ISO 8601 timestamp
- Always include `source_kickoff` in PLAN.md frontmatter
- Always include `source_plan` in TODO.md frontmatter
- Always produce both PLAN.md and TODO.md together
- Always verify all required sections are present before completion
