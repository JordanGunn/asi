...
This supports strict passivity and observability: discovery and narrowing define what is in-bounds; mutation is explicit and attributable; validation gates completion (`docs/spec/rfc-001/.INDEX.md`).
