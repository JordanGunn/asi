...
- missing determinism
- undefined schemas or templates
- unbounded discovery
- ambiguous authority
...
This boundary should **always** be guarded by a reasoning contract implemented via a strict schema emitted by the CLI. This contract should declare the parameters, allowed values, defaults, derivation rules and yield explicit reporting of the derived parameters.
